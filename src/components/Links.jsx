...
const Links = () => {
  const links = [
    {
      id: 1,
      icon: <img src='./Github.svg ' width="30px" height="30px" />,
      link: "https://github.com/KunduVineet",
    },
    {
      id: 2,
      icon: <img src='./LinkedIn.svg ' width="30px" height="30px" />,
      link: "https://www.linkedin.com/in/vineet-kundu-b83407218/",
    },
    {
      id: 3,
      icon: <img src='./Mail.svg ' width="30px" height="30px" />,
      link: "mailto:kunduvineet6@gmail.com",
    },
    {
      id: 4,
      icon: <img src='./Call.svg ' width="30px" height="30px" />,
      link: 'https://wa.me/918882924671?text=Hello, I would love to connect with you!',
      
    },
    {
      id: 5,
      icon: <img src='./Leetcode.svg ' width="30px" height="30px" />,
