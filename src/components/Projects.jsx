...
const Projects = () => {
  const techProjects = [
    {
      id: 1,
      image: "chatting-app-image-url", // Replace with the actual image URL
    ...
    {
      id: 2,
      image: "blogs-image-url", // Replace with the actual image URL
      title: "Blogs",
  ...
  return (
    ...
    <div className="flex flex-wrap ml-5 gap-6 p-5 px-4">
